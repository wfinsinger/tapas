...
## The Matlab code was translated to R language by Olivier Blarquez (see the pretreatment() function in the paleofire R package).
## The pretreatment() function was thereafter modified by Walter Finsinger to get the full output.
##
