...
*R-PaleoAnomalies* performs steps 1.) and 2.) for several variables of one dataset type (e.g. different estimates of charcoal abundance). Instead, steps 3.) and 4.) are performed for one user-selected variable.
...
With these settings, the results obtained using *R-PaleoAnomalies* strikingly resemble those obtained by [Higuera et al. (2009)](https://doi.org/10.1890/07-2019.1) with *CharAnalysis*:
