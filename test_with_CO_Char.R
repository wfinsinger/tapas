...
char_thresh_loc <- local_thresh(series = co_detr, proxy = "charAR", thresh.yr = 500,
                                ...
                                keep_consecutive = F,
                                minCountP = 0.05, MinCountP_window = NULL,
                                out.dir = "Figures")
...
## TEST WITH CONCENTRATION VALUES ########################################################

## Resample the time series
co_i <- pretreatment_data(series = co, out = "conI", series.name = "co",
                          first = -50, last = 7450, yrInterp = yr.interp)
...
## With minimum-count test and removing consecutive peak samples
char_thresh_gl <- global_thresh(series = co_detr, proxy = "char",
                                thresh.value = 0.95, smoothing.yr = NULL,
                                keep_consecutive = F,
                                minCountP = 0.05, MinCountP_window = 150,
                                out.dir = "Figures")
...
## W/out minimum-count test and removing consecutive peak samples
char_thresh_gl <- global_thresh(series = co_detr, proxy = "dummy_chararea",
                                thresh.value = 0.95, smoothing.yr = NULL,
                                keep_consecutive = F,
                                minCountP = NULL, MinCountP_window = 150,
                                out.dir = "Figures")
...
## With minimum-count test and removing consecutive peak samples
char_thresh_loc <- local_thresh(series = co_detr, proxy = "char", thresh.yr = 500,
                                thresh.value = 0.95, smoothing.yr = 500,
                                keep_consecutive = F, minCountP = 0.05,
                                out.dir = "Figures")
...
## TEST WITH COUNT VALUES ################################################################

## Resample the time series
co_i <- pretreatment_data(series = co, out = "countI", series.name = "co",
                          first = -50, last = 7450, yrInterp = yr.interp)
plot(co_i$raw$series$age, co_i$raw$series$char, type = "l")
lines(co_i$int$series.int$age, co_i$int$series.int$char, col = "red")
